...
export const InventProDemo: React.FC = () => {
  ...
  const tabs = [
    { id: 'web' as const, label: 'Web Gerencia (React)', port: 8003, url: 'https://inventpro-web-demo.onrender.com/', desc: 'Panel Admin & Stock' },
    { id: 'bodeguero' as const, label: 'App Bodeguero (Expo)', port: 8005, url: 'https://inventpro-bodeguero-demo.onrender.com/', desc: 'Control Móvil Bodega' },
    { id: 'api' as const, label: 'Backend REST API', port: 3001, url: 'https://inventpro-backend-demo.onrender.com/api-docs/', desc: 'Node.js Express + Swagger' },
  ];
